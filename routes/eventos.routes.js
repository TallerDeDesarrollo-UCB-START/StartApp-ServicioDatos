...
module.exports = function (app) {
  ...
  app.get("/eventos", async (req, res) => {
    try {
      ...
      res.status(404).json(`{"message":"No se pudo obtener los eventos, ${error.message}", "data":false}`);
    }
  });
  ...
  app.get("/eventos/categorias", async (req, res) => {
    try {
      ...
      res.status(404).json(`{"message":"No se pudo obtener las categorias de eventos, ${error.message}", "data":false}`);
    }
  });
  ...
  app.get("/eventos/participantes/:id", async (req, res) => {
    try {
      ...
      res.status(404).json(`{"message":"No se pudo obtener los participantes del evento con id ${req.params["id"]}, ${error.message}", "data":false}`);
    }
  });
  ...
  app.get("/eventos/:id", async (req, res) => {
    try {
      ...
      res.status(404).json(`{"message":"No se pudo obtener el evento con el id ${req.params["id"]}, ${error.message}", "data":false}`);
    }
  });
  app.post(
    ...
    async (req, res) => {
      try {
        ...
        res.status(400).json(`{"message":"No se pudo participar en el evento con el id ${req.params["id"]}, ${error.message}", "data":false}`);
      }
    }
  );
  ...
  app.delete("/eventos/:id", async (req, res) => {
    try {
      ...
      res.status(404).json(`{"message":"No se pudo eliminar el evento con el id ${req.params["id"]}, ${error.message}", "data":false}`);
    }
  });
  ...
  app.put("/eventos/archivar_evento/:id", async (req, res) => {
    try {
      ...
      res.status(404).json(`{"message":"No se pudo editar el evento con el id ${req.params["id"]}, ${error.message}", "data":false}`);
    }
    try {
      ...
      res
        .status(400)
        .json(`{"message":"Cambios no fueron guardados", "data":false}`);
    }
  });
  ...
  app.put("/eventos/mostrar_evento/:id", async (req, res) => {
    try {
      ...
      res.status(400).json(`{"message":"No se pudo editar el mostrar evento con el id ${req.params["id"]}, ${error.message}", "data":false}`);
    }
  });
  ...
  app.get("/eventos/participante/:id", async (req, res) => {
    try {
      ...
      res.status(404).json(`{"message":"No se pudo obtener los eventos del usuario con id ${req.params["id"]}, ${error.message}", "data":false}`);
    }
  });
  ...
  app.get("/lideres", async (req, res) => {
    try {
      ...
      res.status(404).json(`{"message":"No se pudo obtener los lideres, ${error.message}", "data":false}`);
    }
  });
  ...
  app.delete(
    ...
    async (req, res) => {
      try {
        ...
        res.status(404).json(`{"message":"No se pudo eliminar la participacion del usuari con id ${req.params["idUsuario"]}, ${error.message}", "data":false}`);
      }
    }
  );
  ...
  app.get("/sesion/:id_autenticacion/get_my_eventos", async (req, res) => {
    try {
      ...
      res.status(404).json(`{"message":"No se pudo obtener los eventos de usuario con el id ${req.params["id_autenticacion"]}", "data":false}`);
    }
  });
  ...
  app.put("/actualizar_evento/:id", async (req, res) => {
    try {
      ...
      res.status(404).json(`{"message":"No se pudo editar los eventos con el id ${req.params["id"]}, ${error.message}", "data":false}`);
    }
  });
};
